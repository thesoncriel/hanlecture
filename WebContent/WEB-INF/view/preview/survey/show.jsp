...
<div class="section">
<div class="article">
<form action="edit" method="get" enctype="multipart/form-data" class="validator">
<input type="hidden" name="id_group" value="${listData[0].id_group }"/>
...
<div class="item">
    <s:iterator value="listData">
        <ul data-role="listview" data-inset="true">
            <li class="ui-field-contain">
               <label class="questionLabel">정답</label>
