...
<div class="article">
	<div class="user-leave">
		...
		<form action="delete" method="post">		
			...
			<table class="board-edit style3">
				<tbody class="row-scope">
					<tr>
						...
						<td>
							<dl>
								<dd><input type="radio" name="delete_comment" checked="checked" value="영상 불만족"/>영상 불만족</dd>
								<dd><input type="radio" name="delete_comment" value="서비스 불만족"/> 서비스 불만족</dd>
			...
			<button type="submit" class="artn-button board">회원탈퇴</button>
		</form>
	</div>
</div>
</div>
