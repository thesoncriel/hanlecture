...
<ul data-role="listview">
	...
	<s:else>
		<li><a href="profResultExcel?id_prof=${param.id_prof }&id_lect=${param.id_lect }" data-ajax="false">결과표 다운로드</a></li>
	</s:else>
		<li><a href="profshow?contents=${contentsCode }&id=${param.id_lect }">목록</a></li>
</ul>      
